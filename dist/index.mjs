...
var DefaultRenderers = {
  heading_1: ({ node, children }) => /* @__PURE__ */ jsx("h1", { style: { marginTop: "2em", marginBottom: "1em" }, children }),
  heading_2: ({ node, children }) => /* @__PURE__ */ jsx("h2", { style: { marginTop: "1.5em", marginBottom: "0.75em" }, children }),
  heading_3: ({ node, children }) => /* @__PURE__ */ jsx("h3", { style: { marginTop: "1.17em", marginBottom: "0.5em" }, children }),
  paragraph: ({ node, children }) => /* @__PURE__ */ jsx("p", { style: { marginBottom: "1em", lineHeight: 1.5 }, children }),
  bulleted_list_item: ({ node, children }) => /* @__PURE__ */ jsx("li", { children }),
  numbered_list_item: ({ node, children }) => /* @__PURE__ */ jsx("li", { children }),
  code: ({ node }) => {
    const language = node.codeLanguage || "text";
    const content = node.richText?.map((c) => c.text).join("") || "";
    return /* @__PURE__ */ jsx("pre", { style: { background: "#f4f4f4", padding: "1em", borderRadius: "4px", overflowX: "auto" }, children: /* @__PURE__ */ jsx("code", { className: `language-${language}`, children: content }) });
  },
  quote: ({ node, children }) => /* @__PURE__ */ jsx("blockquote", { style: { borderLeft: "4px solid #ccc", margin: "1em 0", paddingLeft: "1em", color: "#666" }, children })
};
var NotionRenderer = ({ nodes, components }) => {
  ...
  const renderRichText = (textItems) => {
    ...
    return textItems.map((item, i) => {
      let element = /* @__PURE__ */ jsx(React.Fragment, { children: item.text }, i);
      if (item.annotations?.bold) element = /* @__PURE__ */ jsx("strong", { children: element }, i);
      if (item.annotations?.italic) element = /* @__PURE__ */ jsx("em", { children: element }, i);
      if (item.annotations?.strikethrough) element = /* @__PURE__ */ jsx("del", { children: element }, i);
      if (item.annotations?.code) element = /* @__PURE__ */ jsx("code", { style: { background: "#eee", padding: "0.2em 0.4em", borderRadius: "3px" }, children: element }, i);
      if (item.link) {
        element = /* @__PURE__ */ jsx("a", { href: item.link, target: "_blank", rel: "noopener noreferrer", style: { color: "#0366d6", textDecoration: "none" }, children: element }, i);
      }
      return element;
    });
  };
  const renderNode = (node, index) => {
    ...
    return /* @__PURE__ */ jsx(Renderer, { node, children }, node.id || index);
  };
  ...
  const flushList = (key) => {
    if (currentListType === "ul") {
      processedNodes.push(/* @__PURE__ */ jsx("ul", { style: { paddingLeft: "2em", marginBottom: "1em" }, children: currentListItems }, key));
    } else if (currentListType === "ol") {
      processedNodes.push(/* @__PURE__ */ jsx("ol", { style: { paddingLeft: "2em", marginBottom: "1em" }, children: currentListItems }, key));
    }
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: processedNodes });
};
